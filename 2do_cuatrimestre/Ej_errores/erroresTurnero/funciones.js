"use strict";
//IMPLEMENTADO TRY - CATCH linea 93
//probar con menu especialidades, modificar y VER DATOS para que salte el error
...
function mostrarNombre(arr) {
    if (arr[0].getNombre() == '') {
        throw new Error('Error: NOMBRE VACIO');
    }
    for (var i = 0; i < arr.length; i++) {
        return "".concat(i + 1, ") ").concat(arr[i].getNombre().toUpperCase(), "\n ");
    }
}
            ...
            switch (op1) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        console.log('ERROR ESPERADO,  DATOS DE ESPECIALIDAD SIN CARGAR\n');
                    }
                    break;
                case 0:
                    break;
